<body class="hold-transition skin-blue sidebar-mini">
    ...
    <aside class="main-sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview {{ addClassToTreeviewMenu('site')[0] }}">
                <a href="#">
                    <i class="fa fa-bars"></i> <span>{{ trans('admin.main') }}</span>
                ...
                <ul class="treeview-menu" style="{{ addClassToTreeviewMenu('site')[1] }}">
                <li><a href="{{ aurl() }}">&nbsp;<i class="fa fa-dashboard"></i>{{ trans('admin.dashboard') }}</a></li>
                <li><a href="{{ aurl('site/settings') }}">&nbsp;<i class="fa fa-cogs"></i>{{ trans('admin.settings') }}</a></li>
                </ul>
            </li>
            <li class="treeview {{ addClassToTreeviewMenu('control')[0] }}">
                ...
                <ul class="treeview-menu" style="{{ addClassToTreeviewMenu('control')[1] }}">
                    <li><a href=" {{ aurl('control') }} "><i class="fa fa-user-secret"></i>{{ trans('admin.admin_accounts') }}</a></li>
            ...
            <li class="treeview {{ addClassToTreeviewMenu('users')[0] }}">
                ...
                <ul class="treeview-menu" style="{{ addClassToTreeviewMenu('users')[1] }}">
                    <li class="active"><a href=" {{ userUrl('control') }} "><i class="fa fa-cog"></i>{{ trans('admin.user_accounts') }}</a></li>
                    <li><a href=" {{ userUrl('control/create') }} "><i class="fa fa-plus"></i>{{ trans('admin.add_user') }}</a></li>
                    <li><a href="{{ userUrl('control') }}?level=client"><i class="fa fa-user-circle"></i> {{trans('admin.client')}} </a></li>
